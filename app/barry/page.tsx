  ...
  return (
    <div className="app-shell mesh-bg">
                ...
                <div>
                  ...
                  <p className="text-text-muted text-xs">
                    ...
                    {plan.barryDropoffTime
                      ? `Drop off by ${plan.barryDropoffTime}`
                      : 'Solo day for Marcos'}
                  </p>
                </div>
              </div>
                ...
                {plan.jobs.map((job, i) => (
                  <div
                    ...
                    className={`px-4 py-3 flex items-center gap-3 ${
                      i < plan.jobs.length - 1 ? 'border-b border-surface-border' : ''
                    }`}
                  >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-text-muted text-xs">
                        {job.scheduledArrival} · ~{job.estimatedDuration} min
                      </p>
                    </div>
                    <span className="text-xs">
                      {job.operative === 'both' ? '👥' : job.operative === 'barry' ? '👷' : '👤'}
                    </span>
                  </div>
                ))}
              </div>
      ...
      <nav className="bottom-nav">
        ...
        <Link href="/barry" className="nav-item active">
          <span className="nav-icon">💬</span>
          <span>Barry</span>
        </Link>
      </nav>
