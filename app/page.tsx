  ...
  return (
    <div className="mesh-bg min-h-dvh flex flex-col items-center justify-center px-6">
      <div className="stagger-1 flex flex-col items-center mb-12">
        ...
        <h1 className="font-display text-2xl font-bold text-text-primary tracking-tight">WGP Planner</h1>
        <p className="text-text-muted text-sm mt-1 font-body">Wirral Garden &amp; Property</p>
      </div>

      <div className="stagger-2 w-full max-w-xs">
        <p className="text-text-secondary text-sm text-center mb-6 font-body">Enter your PIN to continue</p>
      ...
      <div className="stagger-3 absolute bottom-8 text-center">
        <p className="text-text-muted text-xs font-body">Port Sunlight, Wirral · CH62</p>
      </div>
