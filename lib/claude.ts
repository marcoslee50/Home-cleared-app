...
export interface PlanningContext {
  ...
  barryDropoff?: string        // e.g. "15:00"
  barryStartTime?: string      // e.g. "09:30"
  startLocation: string        // default "New Brighton"
  specialTools?: string
...
export interface DayPlan {
  ...
  barrySummary: string         // plain text for Messenger
}
...
Garden: maintenance | planting | turfing | hedges/pruning | clearance | digging | irrigation | tree work
Property: general | gates | hard landscaping | fencing | windows | painting | repairs | skip/waste
Admin: call | quote | invoice | photos | route summary | flag
  ...
  "jobs": [
    {
      ...
      "emoji": "string (1-3 relevant emojis)",
...
Return a JSON object:
{
  ...
  "status": "on-schedule|behind|ahead",
  "minutesDiff": number (positive = behind, negative = ahead),
