...
//
// NOTE: This file currently imports kv at the top level — that fails at runtime
// when KV is not configured. Bug 5 will replace these calls with the dynamic-import
// fallback pattern used in lib/duration-log.ts.
